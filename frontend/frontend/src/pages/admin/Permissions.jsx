...
const ROLE_DEFAULTS = {
  ...
  operations: {
    ...
    suppliers: ['view', 'report', 'edit'],
    notifications: ['view', 'subscribe', 'manage'],
    reports: ['view', 'export'],
  },
  operations_manager: {
    dashboard: ['view'],
...
const RESOURCES = [
  ...
  { key: 'procurement', label: 'Procurement', actions: ['view', 'create', 'edit', 'approve'] },
  { key: 'suppliers', label: 'Suppliers', actions: ['view', 'report', 'edit'] },
  { key: 'notifications', label: 'Notifications', actions: ['view', 'subscribe', 'manage'] },
