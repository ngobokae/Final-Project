...
import { BarChart3, Package, ArrowUpDown, Zap, AlertTriangle, FileText, ChevronRight, User, MessageSquare, Warehouse, QrCode, X } from 'lucide-react';
import logoSrc from '../../assets/IMG_1472.PNG';
import { apiGet } from '../../utils/api';

export default function InventorySidebar({ open = false, onClose }) {
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { to: '/inventory/labels', icon: QrCode, label: 'Label Generator', badge: null },
