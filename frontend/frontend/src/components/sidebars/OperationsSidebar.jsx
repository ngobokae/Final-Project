...
import { BarChart3, Upload, TrendingUp, Factory, Truck, FileText, ChevronRight, User, MessageSquare, X } from 'lucide-react';
import logoSrc from '../../assets/IMG_1472.PNG';
import { apiGet } from '../../utils/api';

export default function OperationsSidebar({ open = false, onClose }) {
